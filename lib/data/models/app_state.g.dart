...
abstract class _$AppStateCWProxy {
  AppState introViewed(bool introViewed);
  ...
  AppState v2mode(bool v2mode);

  AppState currency(Currency? currency);
  ...
  AppState call({
    ...
    return AppState(
      ...
      tutorials: tutorials == const $CopyWithPlaceholder()
          ? _value.tutorials
          // ignore: cast_nullable_to_non_nullable
          : tutorials as Map<String, bool>?,
      hasRecentExport: hasRecentExport == const $CopyWithPlaceholder()
          ? _value.hasRecentExport
          // ignore: cast_nullable_to_non_nullable
