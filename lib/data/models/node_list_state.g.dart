...
abstract class _$NodeListStateCWProxy {
  ...
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `NodeListState(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
...
/// Use as `instanceOfNodeListState.copyWith(...)` or call `instanceOfNodeListState.copyWith.fieldName(value)` for a single field.
class _$NodeListStateCWProxyImpl implements _$NodeListStateCWProxy {
  ...
  @override
  NodeListState endpointNodes(List<Node>? endpointNodes) =>
      call(endpointNodes: endpointNodes);

  @override
  NodeListState duniterIndexerNodes(List<Node>? duniterIndexerNodes) =>
      call(duniterIndexerNodes: duniterIndexerNodes);

  @override
  NodeListState duniterDataNodes(List<Node>? duniterDataNodes) =>
      call(duniterDataNodes: duniterDataNodes);

  @override
  NodeListState ipfsGateways(List<Node>? ipfsGateways) =>
      call(ipfsGateways: ipfsGateways);
  ...
  @override
  NodeListState endpointNodesLastUpdate(DateTime? endpointNodesLastUpdate) =>
      call(endpointNodesLastUpdate: endpointNodesLastUpdate);

  @override
  NodeListState duniterIndexerNodesLastUpdate(
    DateTime? duniterIndexerNodesLastUpdate,
  ) => call(duniterIndexerNodesLastUpdate: duniterIndexerNodesLastUpdate);

  @override
  NodeListState duniterDataNodesLastUpdate(
    DateTime? duniterDataNodesLastUpdate,
  ) => call(duniterDataNodesLastUpdate: duniterDataNodesLastUpdate);

  @override
  NodeListState ipfsGatewaysLastUpdate(DateTime? ipfsGatewaysLastUpdate) =>
      call(ipfsGatewaysLastUpdate: ipfsGatewaysLastUpdate);

  @override
  NodeListState isLoading(bool? isLoading) => call(isLoading: isLoading);
...
extension $NodeListStateCopyWith on NodeListState {
  ...
  /// Example: `instanceOfNodeListState.copyWith(...)` or `instanceOfNodeListState.copyWith.fieldName(...)`.
...
NodeListState _$NodeListStateFromJson(
  ...
  duniterDataNodes: NodeListState._nodesFromJson(
    json['duniterDataNodes'] as List,
  ),
  ...
  duniterIndexerNodesLastUpdate: json['duniterIndexerNodesLastUpdate'] == null
      ? null
...
Map<String, dynamic> _$NodeListStateToJson(
  ...
  'duniterIndexerNodesLastUpdate': instance.duniterIndexerNodesLastUpdate
      ?.toIso8601String(),
  'duniterDataNodesLastUpdate': instance.duniterDataNodesLastUpdate
      ?.toIso8601String(),
  'ipfsGatewaysLastUpdate': instance.ipfsGatewaysLastUpdate?.toIso8601String(),
