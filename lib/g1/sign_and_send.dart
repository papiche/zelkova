...
class SignAndSendResult {
  ...
  final Node? node;
  final sign_and_send.Stream<String> progressStream;
}

sign_and_send.Future<SignAndSendResult> signAndSend(Node node,
    Provider provider, Gtest polkadot, KeyPair wallet, RuntimeCall call,
...
sign_and_send.Future<String> signAndSendOld(
    Gtest polkadot,
    KeyPair wallet,
    RuntimeCall call,
    Provider provider,
    sign_and_send.Completer<String> result,
