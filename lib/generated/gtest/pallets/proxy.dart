...
import '../types/gtest_runtime/proxy_type.dart' as _i12;
...
class Queries {
  ...
  final _i2.StorageMap<_i3.AccountId32,
          _i4.Tuple2<List<_i5.ProxyDefinition>, BigInt>> _proxies =
      const _i2.StorageMap<_i3.AccountId32,
          _i4.Tuple2<List<_i5.ProxyDefinition>, BigInt>>(
    prefix: 'Proxy',
    storage: 'Proxies',
  ...
  final _i2
      .StorageMap<_i3.AccountId32, _i4.Tuple2<List<_i7.Announcement>, BigInt>>
      _announcements = const _i2.StorageMap<_i3.AccountId32,
          _i4.Tuple2<List<_i7.Announcement>, BigInt>>(
    prefix: 'Proxy',
  ...
  /// The announcements made by the proxy (key).
  _i8.Future<List<_i4.Tuple2<List<_i7.Announcement>, BigInt>>>
      multiAnnouncements(
    List<_i3.AccountId32> keys, {
    _i1.BlockHash? at,
  }) async {
