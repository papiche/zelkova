...
class Queries {
  ...
  final _i2.StorageMap<int, List<_i4.Scheduled?>> _agenda =
      const _i2.StorageMap<int, List<_i4.Scheduled?>>(
    prefix: 'Scheduler',
    storage: 'Agenda',
    valueCodec: _i3.SequenceCodec<_i4.Scheduled?>(
        _i3.OptionCodec<_i4.Scheduled>(_i4.Scheduled.codec)),
  ...
  final _i2.StorageMap<List<int>, _i5.Tuple2<int, int>> _lookup =
      const _i2.StorageMap<List<int>, _i5.Tuple2<int, int>>(
    prefix: 'Scheduler',
    storage: 'Lookup',
