...
import '../../gtest_runtime/proxy_type.dart' as _i5;
...
class DepositPoked extends Event {
  ...
  factory DepositPoked._decode(_i1.Input input) {
    return DepositPoked(
      ...
      oldDeposit: _i1.U64Codec.codec.decode(input),
      newDeposit: _i1.U64Codec.codec.decode(input),
    );
  }
  ...
  int _sizeHint() {
    ...
    size = size + _i1.U64Codec.codec.sizeHint(oldDeposit);
    size = size + _i1.U64Codec.codec.sizeHint(newDeposit);
    return size;
  }
