...
class $Event {
  ...
  IfElseFallbackCalled ifElseFallbackCalled(
      {required _i3.DispatchError mainError}) {
...
class IfElseFallbackCalled extends Event {
  ...
  factory IfElseFallbackCalled._decode(_i1.Input input) {
    return IfElseFallbackCalled(
        mainError: _i3.DispatchError.codec.decode(input));
  }
