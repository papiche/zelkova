...
void main() {
  test('walletV2Auth falls back when stored key is missing', () async {
    ...
    final LocalAuthPlatform previous =
        registerMockLocalAuth(authenticateResult: true);

    final Uint8List fallbackKey = Uint8List.fromList(<int>[5, 6, 7]);
